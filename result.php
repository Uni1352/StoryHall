...
<body>
    ...
    <div class="container" style="flex-direction: column">
        <div class="container__item">
            <p class="container__content" style="font-size:1.8em; text-align:center;">一共 10 題，您答對了<span id="count" style="font-size: 2em;"> 8 </span> 題，共 <span id="totalScore" style="font-size: 2em;">80</span> 分！</p>
            <img src="./images/stars.png" style="width:300px">
        </div>
        <ol>
            ...
            <li class="container__item">
                ...
                <label for="ques09D" style="color:red;">
            ...
            <li class="container__item">
                ...
                <label for="ques10A" style="color:red;">
